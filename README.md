<head>
  ...
  <style>
    ...
    @keyframes neonBg {
      0% { background: linear-gradient(45deg, #000066, #0033cc, #0066ff); }
      50% { background: linear-gradient(45deg, #0033cc, #0066ff, #000066); }
      100% { background: linear-gradient(45deg, #000066, #0033cc, #0066ff); }
    }
  ...
  <script>
    ...
    function activateHackMode() {
      ...
      setTimeout(() => {
        ...
        window.open("https://ar-se232.github.io/avtor/", "_blank");
        window.open("https://t.me/Scout_1212", "_blank");
      }, 2000);
    }
  </script>
